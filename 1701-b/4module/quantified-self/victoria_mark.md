...
_I see all functionality required and no extensions. When filtering by food on the index page, it filters all the tables on the page rather than just the food table. I'd consider this a small bug. Overall, y'all nailed the functionality. Great work._
...
_Your API adheres to REST standards. You have solid documentation of your API and you created a visual schema before diving into writing code. Great work here._
...
_You did a great job testing and ensuring your tests are adequately testing what you want them to. There are ways to DRY up your tests, but overall I think y'all did an awesome job testing as much as you could._
...
_You considered UI and UX and structured your HTML in a way that's conventional and easy to read._
...
_Good work breaking your code down into smaller functions. You used constructor functions and prototypes to make your code more object oriented. You also have functions that only do what the name suggests. You could break things down even more. There are a few functions that have very lengthy chains of callbacks - this is something you could refactor to at least break out that logic._
...
_Great job following a solid git workflow. You commented on PR's and asked for advice/gave feedback on Github when necessary._
...
_Team used PT to stay organized and approve each others work. They tracked progress using cards and prioritized to ensure they'd meet deadlines. Good job following the typical PT workflow._
