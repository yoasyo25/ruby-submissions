...
## Notes:
* Complete w 2 extensions
* Model tests solid, feature tests a little weak (not verifying datapoints and detail to degree desired)
* Code pretty clean
* Mixed use of ActiveRecord and Ruby to conduct analytics
