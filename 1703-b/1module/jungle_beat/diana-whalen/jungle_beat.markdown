...
* Good start to testing.
* Nice use of recursion on `tail` method.
* Good start to testing. Some functionality is written but not tested.
* Components are broken apart nicely (Node, LinkedList)
