...
Repo: https://github.com/alex549us3/re-battleship

Notes:

* chunks of code lost in gitastrophe
* would like to see more evidence of TDD
* remove puts from methods returning String, use puts when calling method
