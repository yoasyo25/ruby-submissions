...
Repo: https://github.com/wthoma22/battleship_project

Notes:

* focused on getting game running vs validations (2.5 on functionality)
* long methods in player and comp classes that should be refactored (force yourself with TDD to start with smaller methods)
...
* **2.5: Application meets all requirements as laid out per the specification.**
