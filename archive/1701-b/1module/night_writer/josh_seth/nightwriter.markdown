...
Project Repo: https://github.com/josh-works/night_writer

Notes: 
* Numbers working, base expectations falling short on writing to message.txt
* Consider adding an alphabet module
