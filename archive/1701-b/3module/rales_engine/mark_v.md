...
* README doesn't include instructions on how to set up project and import data. There doesn't appear to be a rake task and the seed file is empty.
* Test coverage is 69.3%
