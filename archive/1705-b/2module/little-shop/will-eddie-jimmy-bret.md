...
* Admin functionality all in place, just missing link helper to items new page
* Product reviews extension working
* Really good teamwork
* Good controller and model refactors, good use of partials in views
* SASS partials for styles
