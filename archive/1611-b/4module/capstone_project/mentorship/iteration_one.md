...
*I'm glad you are using pivotal tracker to create your stories but I only see one story in the done category.  How is a client supposed to keep track of what stories are done?  In the "real world" a client won't be attending standups, they are
going to look at your project board to see your progress.*
...
*Some of the react code I've seen looks pretty good and is functional.  Also trying to change a gem is a difficult task, so good job on both fronts*
