...
- Missing dates
- A couple bugs here and there, but most functionality is done correctly
- Code for tests is well organized. I like the file/folder structure
- However, most tests are still unwritten
- JS naming is good.
- JS is divided into two files, but could be divided into more files
- Good use of Github and Tracker
