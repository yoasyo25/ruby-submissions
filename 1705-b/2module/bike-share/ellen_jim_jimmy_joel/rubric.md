...
## Repo: https://github.com/JoelLindow/bike-share

## Notes:

* Models have really well refactored business logic
* Waffle shows real-time progress through cards
* UI is nice and clean. Some pages could use more styling
* GitHub was used really well
* Controller logic is minimal, nice use of controller as dispatcher
