...
Notes:
- Overall, nice job!
- Joan's descriptions were CLUTCH!
- Some holes in UX/UI
- Some small logic that could be pushed from views to controller/models.
- Some refactoring in the models
- Would like to see full method testing but test suite is thorough
- Nice conversations happening on git, could use more!
- THE CART ICON!
