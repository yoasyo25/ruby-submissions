...
Notes:
- Needs some polishing for Usability. models have some logic in them that should be in other models. Testing was strong but no method on the model testing 
