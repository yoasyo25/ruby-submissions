...
- Overall, nice to use, a couple of interactions that need to be improved.
- A decent amount of logic in the views with sum and database calls.
- Controllers are especially clean and well-refactored
- Some refactoring in the models
- Testing was strong and model tests but through analytics. talked about improvements
